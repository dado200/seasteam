...
setInterval(() => {
  http.get(`https://gbotsystem.glitch.me`);
}, 280000);
...
///
//الاكواد
const dev = ["490521551427600394"]; ///تعديل مهم حط ايدي حسابك
const admin = "=";
var owner = "490521551427600394"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity(` ${client.guilds.size} Servers `); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@490521551427600394>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage(
        ""
      )
...
client.on("message", message => {
  ...
  if (message.content === "فتح") {
    ...
    message.channel
      ...
      .then(() => {
        message.reply("تم فتح الشات ياحلو  ");
      });
  }
});
...
client.on("message", message => {
  if (message.content.startsWith(`<@${client.user.id}>`)) {
    ...
    let mention = new Discord.RichEmbed()
      .setColor("black")
      .setDescription(
        ` ✽  **هلا انا بوت <@490521551427600394> الاداري **  
✽  **سيرفر الدعم الفني** [ https://discord.gg/XkmCJaC ] 
✽  **Bot orders** [ • **=help** • ]   `
      )
...
client.on("message", message => {
  ...
  if (message.content === prefix + "1help") {
    ...
    message.author.sendMessage(` ✽ **__ GBot v1__**
**__الاوامر العامه__** 
...
client.on("message", message => {
  ...
  if (message.content === prefix + "2help") {
    message.channel.send(
      `**:innocent:  | تم ارسال الاوامر الإدارية على الخاص **`
    );
    
    message.author.sendMessage(` **✽ GBot v1**
   **__الاوامر الإداريــه__** ✽ 
**  =clear • لمسح الشات** 
**  =ban • لتبنيد شخص** 
**  =kick • لاعطاء كيك لشخص** 
**  اسكت • لاعطاء ميوت لشخص** 
**  تكلم • لفك ميوت عن شخص** 
**  =new •  فتح التكت**
**  =move •  لسحب الشخص الى روومك**
** قفل  • تقفل الروم الي تبيه
** فتح • فتح الروم الي تبيه
...
client.on("message", message => {
  ...
  if (message.content === prefix + "3help") {
    message.channel.send(
      `** :innocent: | تم ارسال اوامر الموسيقى في الخاص**`
    );

    message.author.sendMessage(`  **GBot v1**
  **__أوامر الــمــوســيــقــى__**   
$p لتشغيل الموسيقي
$s لعمل تخطي للموسيقي
...
client.on("message", message => {
  ...
  if (message.content === prefix + "4help") {
    ...
    message.channel.send(
      `**:innocent:  | تم ارسال اوامر الحماية على الخاص **`
    );
...
client.on("message", message => {
  ...
  if (message.content === prefix + "5help") {
    ...
    message.channel.send(
      `**:innocent:  | تم ارسال الاوامر المميزة على الخاص **`
    );
...
client.on("message", msg => {
  if (msg.content === "اكرهك") {
    msg.reply("وانا لا احبك اصلا");
  }
});
client.on("message", msg => {
  if (msg.content === "احبك") {
    msg.reply("**  وانا اكثر خوي💖💕**  ");
  }
});
client.on("message", msg => {
  if (msg.content === "._.") {
...
client.on("message", msg => {
  if (msg.content === "ابي كريديت") {
    msg.reply("ممنوع طلب الكريديت");
  }
});
client.on("message", msg => {
  if (msg.content === "ابي رتبه") {
    msg.reply("ممنوع طلب الرتب");
  }
});
client.on("message", msg => {
  if (msg.content === "ابي فلوس") {
    msg.reply("ممنوع طلب الفلوس");
  }
});
client.on("message", msg => {
  if (msg.content === "راح اروح اصلي") {
    msg.reply("تقبل الله منا ومنكم ");
  }
});
client.on("message", msg => {
  if (msg.content === "بدي كريديت") {
    msg.reply("ممنوع طلب الكريديت");
  }
});
client.on("message", msg => {
  if (msg.content === "بدي فلوس") {
    msg.reply("ممنوع طلب فلوس");
  }
});
client.on("message", msg => {
  if (msg.content === "بدي رتبه") {
    msg.reply("ممنوع طلب رتب");
  }
});
client.on("message", msg => {
  if (msg.content === "ممكن كريديت") {
    msg.reply("ممنوع طلب الكريديت");
  }
});
client.on("message", msg => {
...
client.on("message", msg => {
  if (msg.content === "°-°") {
    msg.reply("وش فيك منبهر؟");
  }
});
client.on("message", msg => {
  if (msg.content === "باي") {
    msg.reply("مع السلامة");
  }
});
client.on("message", msg => {
  if (msg.content === "راح اروح") {
    msg.reply("الله يوفقك");
  }
});
...
if(g.id === "720205439295553587") return;
 g.leave()
})
client.login("NzQwMjU0NzY0NjA3OTk1OTQ0.XymV-Q.WkoZUyxa5-Ab_7-xtJqaiM8wjZI");